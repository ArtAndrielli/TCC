...
func _ready() -> void:
	...
	# Por exemplo a posição (0;0): iniciar com o valor de x = 0 pois, no gráfico de x,
...
func _process(delta: float) -> void:
	Marcador.position.y = linearCrescenteX  # A posição do marcador no eixo Y é igual a variavel x.
